...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Proyecto_final.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4002070
SOPC_SYSID_FLAG += --sidp=0x4002070
ELF_PATCH_FLAG  += --sidp 0x4002070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1476894139
SOPC_SYSID_FLAG += --timestamp=1476894139
ELF_PATCH_FLAG  += --timestamp 1476894139
